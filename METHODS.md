...
v0.3 intentionally excludes raw private transcripts, screenshots, personal identifiers, account details, local machine paths, and third-party information. The public package exposes aggregate/frozen outcomes and bounded engineering summaries.

## Interpretation rule
A result marked ENGINEERING-VERIFIED does not imply product usefulness. A naturalistic observation does not imply causal generalization. A null result is not equivalence outside the tested slice.
